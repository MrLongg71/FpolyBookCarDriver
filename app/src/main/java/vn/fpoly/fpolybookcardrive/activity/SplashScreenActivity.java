...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String longitude = sharedPreferences.getString(Constans.KEY_BUNDEL_LONGITUDE_CURRENT,"");
        String latitude = sharedPreferences.getString(Constans.KEY_BUNDEL_LATITUDE_CURRENT,"");
        ...
        locationTask.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    editor.putString(Constans.KEY_BUNDEL_LATITUDE_CURRENT, String.valueOf(location.getLatitude()));
                    editor.putString(Constans.KEY_BUNDEL_LONGITUDE_CURRENT, String.valueOf(location.getLongitude()));
                    editor.commit();
                }
            }
        });
